...
Dado que la restricción $\textbf{S} \mid_n$ genera una artición sobre $\textbf{S}$ es posible extender $X_i$ a todo $\textbf{S}$ teniendo en cuenta que $X_i(s)$ no está definido cuando $i > n_s$.
...
## Teorema de valor esperado^[Confirmar]

Sean $(\Omega, \mathcal{A}, P)$ un espacio deprobabilidad cualquera fijo, $(\textbf{S}\mid_\mu, \sigma(P^*), P^*)$ un cielo de puntos, $\mathbb{E}$ un espacio vectorial sobre los reales y $f: (\Omega, \mathcal{A}, P) \rightarrow \mathbb{E}$ una función (medible? continua?). Entonces $e_f$ el valor esperado visto como opreador sobre el cielo de puntos
