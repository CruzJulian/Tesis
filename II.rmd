...
## Semidistancia de Minkowski controlada por tamaño entre nubes de puntos
...
Sean $(\Omega, \mathcal{B})$, $h$ una función creciente de $\mathbb{R}^+$ en sí mismo y $d$ una distancia de Minkowski entre funciones de $(\Omega, \mathcal{B})$ en $\mathbb{R}$. Dadas dos nubes de puntos $s_1$ y $s_2$, con sus medidas de probabilidad empírica $P_{s_1}$ y $P_{s_2}$ y sus funciones de densidad general empírica $f_{s_1}$ y $f_{s_2}$ y tamaños $n_{s_1}$ y $n_{s_2}$; se define la función $\mathtt{d}(s_1, s_2) =  h(n_{s_1}, n_{s_2})d(f_{s_1}, f_{s_2})$.

$\mathtt{d}$ se denomina semidistancia de Minkkowski entre nubes de puntos. Como se explicó anteriormente se trata de una semidistancia y no d una distancia. La función $h$ permite controlar la similaridad entre nubes de puntos de acuerdo a sus tamaños. La integrabilidad de las funciones de densidad general permite el uso de la distancia de Minkowski. El caso contínuo puede examinarse a la luz de las funciones de densidad acumulada y acumulada empírica, no obstante los resultados teóricos son bastante más generales. tanto el orden de la distancia $d$, así como las características idóneas de la función $h$ deben er examinados mediante experimentación.
