...
Sean $(\mathbb{R}^k, \mathcal{B}^k, \lambda)$ un espacio de medida cualquera fijo y $(\textbf{S}, \wp(\textbf{S}), P^*)$ su cielo de puntos. Sea $e$ el valor esperado visto como opreador sobre el cielo de puntos.

\begin{align}
e &:  (\textbf{S}, \wp(\textbf{S}), P^*) \longrightarrow (\mathbb{R}^k, \mathcal{B}^k, P, \lambda)\\
...
Entonces
 ...
 - Su valor esperado $E(s) = \int e dP^*$ es igual a $\int X dP$ (siendo X(x) = x).
