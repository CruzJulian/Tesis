...
``En 2007, la humanidad pudo almacenar $2,9 \times 10^{20}$ bytes óptimamente comprimidos, comunicar casi $2 \times 10^{21}$ bytes y llevar a cabo $6.4 \times 10^{18}$ instrucciones por segundo en equipos de uso general.'' \cite{Hilbert60}
...
## Diseño de experimentos
 ...
 - El tamaño muestral crecce y los p-valores disminuyen.
...
## Conclusiones
 ...
 - El software desarrollado y la programación correspondiente a los métodos propuestos se encuentra en el repositorio de la tesis, no hay áun un paquete en R para estos métodos.
