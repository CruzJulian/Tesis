...
```{r ecdf_plot2, fig.width = 8, fig.height = 2.5}
dff_to_plot_2 %>% 
    ggplot +
    aes(x = TOTAL, colour = grupo) +
    geom_step(stat = "ecdf") +
    xlab("") +
    ylab("") + theme_minimal() +
    theme(legend.position = "bottom") -> general_ecdf_plot
...
```{r Colmaps_todo, fig.width=11, fig.height=13}
RESULTADO %<>% mutate(Grupo = as.ordered(grupo))
