...
---
De manera metarfórica es posible construir un discurso en donde la
información está ordenada en forma de capas o sustratos siendo el primer
sustrato el de los individuos, donde se ha tomado las mediciones
primarias; una segunda capa concerniente a comunidades, clanes o nubes,
conformadas por los individuos; y una última capa formada por la
información global procesada referente a toda la muestra y en el caso
inferencial, a toda la población.
