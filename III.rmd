...
data.frame(n1_peque, n2_peque) %>% ggplot + geom_step(aes(x = value), stat = "ecdf") + geom_step(aes(x = value.1), stat = "ecdf") + theme_minimal() + labs(x = "Valores", y = "FDE")
...
data.frame(n1_grande, n2_grande) %>% ggplot + geom_step(aes(x = value), stat = "ecdf") + geom_step(aes(x = value.1), stat = "ecdf") + theme_minimal() + labs(x = "Valores", y = "FDE")
...
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D0.normal) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D0.uniforme) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
...
```{r, fig.width = 3.5, fig.height = 2.5}
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D1.normal) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D1.uniforme) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
...
```{r, fig.width = 3.5, fig.height = 2.5}
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D2.normal) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D2.uniforme) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
...
```{r, fig.width = 3.5, fig.height = 2.5}
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D3.normal) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D3.uniforme) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
...
```{r, fig.width = 3.5, fig.height = 2.5}
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D4.normal) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D4.uniforme) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia")+ scale_fill_gradient(high = "#333355", low = "#ffffff")
...
```{r, fig.width = 3.5, fig.height = 2.5}
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D5.normal) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia") + scale_fill_gradient(high = "#333355", low = "#ffffff")
dis_frame %>% ggplot + aes(x = Var1, y = Var2, fill = D5.uniforme) + geom_raster() + theme_minimal(base_size = 6) + labs(x ="", y = "", fill = "Distancia") + scale_fill_gradient(high = "#333355", low = "#ffffff")
...
```{r}
dis_frame %>% filter(Var1 != Var2) %>% mutate(min_12 = apply(cbind(Var1, Var2), 1, min), max_12 = apply(cbind(Var1, Var2), 1, max)) %>% lm(log(D0.normal) ~ log(min_12) + log(max_12), data = .) -> modelo_1

stargazer(modelo_1, summary = TRUE)
...
```{r}
dis_frame %>% filter(Var1 != Var2) %>% mutate(min_12 = apply(cbind(Var1, Var2), 1, min), max_12 = apply(cbind(Var1, Var2), 1, max)) %>% lm(log(D0.uniforme) ~ log(min_12) + log(max_12), data = .) -> modelo_2

stargazer(modelo_2, summary = TRUE)
...
ep_means <- function(lista_nubes, n_grupos = NULL, grupos_iniciales = NULL){
  ...
  data.frame(trt = names(lista_nubes), Grupo = grupos, stringsAsFactors = FALSE)
...
Simul_tabla <- function(sigma){
  ...
  #Duncan
  aov(Y~X, data = datos) %>% duncan.test("X") %$% groups %>% mutate(trt = rownames(.), grupos = groups) %>% select(-Y, -groups) -> DUNCAN
